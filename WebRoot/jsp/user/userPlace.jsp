...
<body onload="init()">
	<div class="header">
		...
		<div class="tool">
			<ul style="margin-right:10px;">
				<li><a href="jsp/user_login.jsp">登录</a>
				</li>
				<li><a href="jsp/user_register.jsp">创建用户</a>
				</li>
			</ul>
		</div>
		<%
	...
	<script type="text/javascript" src="js/util/vote.js"></script>
	<script type="text/javascript" src="js/data/college.js"></script>
	<script type="text/javascript" src="js/map/software.js"></script>
